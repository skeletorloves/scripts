...
function MajorTom() {
	...
	my_townThings(4, true, "waypoint", 10000, 12000, "wBoer", 10000, 16000);
	...
	my_townThings(4, true, "waypoint", 15000, 20000, false);
...
*/
function my_townThings(	_act, _chores, _wppt, _tdelayA, _tdelayB, _troops, _ttdelayA, _ttdelayB) {
	...
	delay(rand(_ttdelayA, _ttdelayB));
	if(me.classid !== 4) Precast.doPrecast(true);
...
function d2_countess() {
	...
	var i, poi;
	my_townThings(false, true, "waypoint", false, false, "wBoer", 4000, 7000);
...
function d2_andy() {
	...
	my_townThings(false, false, "waypoint", 2000, 4000, false);
	my_townThings(1, false, "waypoint", 6000, 8000, "wBoer", 7000, 9000);
	...
	//Attack.clearLevel(0);
	Pather.moveTo(22563, 9556);
	my_townThings(false, true, "waypoint", 6000, 8000, "wBoer", 7000, 9000);

	return true;
}
function d2_summoner() {
	me.overhead("Starting summoner...");
	my_townThings(2, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
	...
	my_townThings(false, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
...
function d2_mephisto() {
	...
	my_townThings(3, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
...
function d2_abaddon() {
	...
	my_townThings(5, true, "waypoint", 6000, 8000, "woBoer", 7000, 10000);
	...
	delay(rand(2000,5000));
	my_townThings(false, true, "waypoint", 6000, 8000, "wBoer", false, false);
...
function d2_hallsofpain() {
	...
	my_townThings(4, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
	...
	delay(rand(2000,5000));
	my_townThings(false, true, "waypoint", 6000, 8000, "woBoer", 7000, 10000);
...
function d2_ldrBaal(_tSorc) {
	...
	myTroops.prepTroops(107, false);
	my_townThings(5, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
...
function d2_ldrPindle(_tSorc) {
	...
	my_townThings(false, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
	my_townThings(4, false, "waypoint", false, false, "wBoer", 7000, 10000);
...
function d2_diablo() {
	...
	myTroops.prepTroops(107, false);
	my_townThings(false, true, "portalspot", 6000, 8000, "wBoer", 7000, 10000);	
...
function d2_Nihlathak() {
	...
	my_townThings(4, true, "waypoint", 6000, 8000, "wBoer", 7000, 10000);
	myTroops.prepTroops(107, true);
	my_townThings(5, false, "waypoint", false, false, "wBoer", 7000, 10000);
