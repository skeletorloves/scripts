...
var Config = {
	...
	// dEdits: added the localchat feature which is in Limedrop	
	...
	socketeers: false,		// dEdits: for how socket followers will responds to leader
	chantingrush: true, 	// dEdits: to enable/diasable chantress' chanting while rushing
	ldrSorcTele: true,		// dEdits: for enabling/disabling sorc leader from teleing
	LocalChat: false,		// dEdits: for using console local chats
	PublicMode: false,
	...
	debugChat: false,
	meHPmaxOrig: 0,								// for checking if the bo has worn off
	Troops: [],									// leader's team of followers [bo barb, telesorc, extra peeps]
	BObarb: {
		Triggers: ["troops", "burgers", "coffee"],
		BObarb: "none",
		TeleSorc: "none",
		GameLength: 120,
		ldr: "",
		Towners: [],								// [bo barb, druid] : peeps who cannot tele
		BOCows:[]
	},
	BattleOrders: {
		Mode: 0,
